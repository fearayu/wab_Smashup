(function(root){
 ...
 root.SmashRules={keys,courts,sessions,pending,escape,localDate,lastDate,read,list,session,actor,active,start,normalize,expired,dateTime,courtConflict,locked,write,bookCourt,bookBuffet,requestService,canCancel,cancel,setStatus};
